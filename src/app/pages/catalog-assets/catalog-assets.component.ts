...
@Component({
  selector: 'app-catalog-assets',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './catalog-assets.component.html',
  styleUrls: ['./catalog-assets.component.scss']
})
export class CatalogAssetsComponent implements OnInit {
  services: Service[] = [];
