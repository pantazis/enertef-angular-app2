...
@Component({
  selector: 'app-catalog-partner',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './catalog-partner.component.html',
  styleUrls: ['./catalog-partner.component.scss']
})
export class CatalogPartnerComponent implements OnInit {
  services: Service[] = [];
